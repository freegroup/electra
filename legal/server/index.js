...
const PORT = process.env.PORT_LEGAL || die("missing env variable PORT_LEGAL");
const LOCALHOST = process.env.LOCALHOST || die("missing env variable LOCALHOST");

// Create Express Server
const app = express();

app.use('/legal', express.static(scriptPath+'/../public'));
...
app.listen(PORT, LOCALHOST, () => {
    console.log(`Starting /legal at http://${LOCALHOST}:${PORT}`);
});
