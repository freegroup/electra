...
class Application  extends AppFrame{
  ...
  init(permissions) {
    ...
    return new Promise( (resolve, reject)=>{
      this.termsView = new AuthorPage("#markdownContainer", "readme/{{lng}}/legal/terms.sheet")
      this.cookieView = new AuthorPage("#markdownContainer", "readme/{{lng}}/legal/cookie.sheet")
      this.privacyView = new AuthorPage("#markdownContainer", "readme/{{lng}}/legal/privacy.sheet")
  
      this.termsView.render()
  
      $("#show-terms").on("click", this.termsView.render.bind(this.termsView))
      $("#show-cookie").on("click", this.cookieView.render.bind(this.cookieView))
